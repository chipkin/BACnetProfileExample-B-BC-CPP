...
From release [v1.0.0](https://github.com/chipkin/BACnetProfileExample-B-BC-CPP/releases/tag/v1.0.0).
v1.0.0 was built with `CAS_BACNET_STACK_LINK=STATIC`; the next release refreshes
these numbers from the SOURCE-mode build documented above.
